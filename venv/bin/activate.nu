...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/aferrer/Proyectos/Python/networkBalancing/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/aferrer/Proyectos/Python/networkBalancing/venv/bin/deactivate.nu'
